...
const NoteArticle = ({
	...
	return (
		<>
			...
			<div className="flex w-11/12 flex-col items-center gap-4  p-4  ">
				...
				{error ? (
					...
					<div className="border-accent-500 flex w-full flex-col items-center gap-4 border-1">
								...
								<>
									{searchTerm && (
										<div className="flex justify-end gap-2 md:gap-4">
											<button
												className="hover:border-accent-200/60 hover:bg-accent-50 dark:hover:border-accent-500/20 flex cursor-pointer items-center rounded-lg border border-[#e8e8e8] bg-white/50 px-2 py-1.5 transition-all duration-200 dark:border-white/[0.07] dark:bg-white/[0.05] dark:hover:bg-white/[0.08]"
															...
															{editingNoteId === note.id ? (
																<>
																	<section className="flex w-full flex-col gap-1.5">
																		<label
																			htmlFor="noteTitle"
																			className="text-[11px] font-semibold tracking-widest text-[#888] uppercase dark:text-[#666]"
																		>
																			Título
																		</label>
																		<input
																			type="text"
																			value={noteTitle}
																			className="focus:border-accent-400 focus:ring-accent-400/20 dark:focus:border-accent-500 dark:focus:ring-accent-500/20 w-full rounded-lg border border-[#e5e7eb] bg-white px-3 py-2 text-sm font-bold tracking-widest text-black uppercase transition-all outline-none focus:ring-2 dark:border-white/[0.1] dark:bg-[#1e1e1e] dark:text-white"
																	...
																	<section className="flex w-full flex-col gap-1.5">
																		...
																		<textarea
																			...
																			id="noteDescrip"
																			value={noteMessage}
																			className="focus:border-accent-400 focus:ring-accent-400/20 dark:focus:border-accent-500 dark:focus:ring-accent-500/20 min-h-[80px] w-full resize-none rounded-lg border border-[#e5e7eb] bg-white px-3 py-2 text-[13px] leading-relaxed text-[#333] transition-all outline-none focus:ring-2 dark:border-white/[0.1] dark:bg-[#1e1e1e] dark:text-[#ddd]"
																...
																<>
																	<span className="bg-accent-50 text-accent-700 dark:bg-accent-500/10 dark:text-accent-400 inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-[11px] font-semibold">
