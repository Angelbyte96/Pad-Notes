			...
			>
				<section id="sendNotes" className="flex w-full flex-col items-center gap-4">
					...
					<form className="flex w-full flex-col justify-center gap-2" onSubmit={handleSubmit}>
						...
						<textarea
							type="text"
							className="field-sizing-content max-h-[40dvh] w-full overflow-y-auto break-words whitespace-normal rounded-lg border border-[#e5e7eb] bg-white px-3 py-2 text-sm text-black outline-none transition-all placeholder:text-[#aaa] focus:border-accent-400 focus:ring-2 focus:ring-accent-400/20 dark:border-white/[0.1] dark:bg-[#1e1e1e] dark:text-white dark:placeholder-[#555]"
							id="note"
							name="note"
							value={note}
