	...
	return (
		<Dialog.Root open={isOpen} onOpenChange={onOpenChange}>
			...
			<Dialog.Portal>
				...
				<Dialog.Content className="fixed top-1/2 left-1/2 z-50 max-h-[85dvh] w-11/12 max-w-md -translate-x-1/2 -translate-y-1/2 overflow-x-hidden overflow-y-auto overscroll-contain rounded-2xl border border-[#e8e8e8] bg-white/70 p-5 text-left text-black shadow-2xl shadow-black/20 backdrop-blur-xl md:w-6/12 dark:border-white/[0.07] dark:bg-[#1e1e1e]/75 dark:shadow-black/60">
